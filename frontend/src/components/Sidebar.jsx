...
import { LayoutDashboard, ShoppingCart, FileText, AlertCircle, BarChart3, Upload, Users, LogOut, Store, PackagePlus, CarFront, ClipboardCheck } from 'lucide-react';
...
const NAV_ADMIN = [
  ...
  { to: '/conciliacion-erp', label: 'Conciliación ERP', icon: ClipboardCheck },
