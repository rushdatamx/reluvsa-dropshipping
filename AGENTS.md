# AGENTS.md — Portal Dropshipping RELUVSA

> Este archivo es el contexto canónico para cualquier sesión de Codex que retome el proyecto. Léelo antes de tocar código.
...
├── docs/                             # ⭐ el detalle largo vive aquí; el AGENTS.md sólo enlaza
...
`~/.Codex/projects/-Users-jmariopgarcia-Desktop-2026-RushData-RELUVSA-dropshipping-reluvsa/memory/`:
